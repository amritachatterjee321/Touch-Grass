...
export function BottomNavigation({ activeTab, onTabChange }: BottomNavigationProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50" style={{
      ...
      <div className="flex justify-around items-center py-2" style={{
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center px-1 py-1 transition-all duration-300 transform group touch-manipulation min-w-[32px] min-h-[30px] ${
                isActive 
            ...
            >
              ...
              <span 
                className={`text-xs mt-0.5 font-bold uppercase tracking-wider transition-colors duration-300 text-center ${
                  isActive 
